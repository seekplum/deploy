...
```bash
ansible-playbook site.yml -e @.local-variables.yml -i hosts -t install --skip-tags "configure,initialize,zsh,python,virtualenv,rbenv,docker,golang,java,nodejs,helm,k3s,ansible"
