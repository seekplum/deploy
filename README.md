...
```bash
ansible-playbook site.yml -i hosts -t install --skip-tags "configure,initialize,zsh,python,virtualenv,pyenv,rbenv,pyconcreate,docker,golang,java,nodejs,helm,k3s,ansible"
